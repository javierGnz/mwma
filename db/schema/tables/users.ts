...
export const userRelations = relations(usersTable, ({ one }) => ({
	owner: one(ownersTable, { fields: [usersTable.id], references: [ownersTable.user_id] }),
	mechanic: one(mechanicsTable, { fields: [usersTable.id], references: [mechanicsTable.user_id] }),
}));
